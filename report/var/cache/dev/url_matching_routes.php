...
return [
    ...
    [ // $staticRoutes
        ...
        '/lucky' => [[['_route' => 'lucky', '_controller' => 'App\\Controller\\LuckyController::number'], null, null, null, false, false, null]],
        '/quote' => [[['_route' => 'quote', '_controller' => 'App\\Controller\\QuoteControllerJson::jsonNumber'], null, null, null, false, false, null]],
